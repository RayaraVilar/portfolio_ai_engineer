    ...
    <section className="min-h-screen flex items-center pt-24 pb-12 px-4 md:px-8 max-w-6xl mx-auto relative">
      <div className="grid md:grid-cols-2 gap-10 items-center w-full">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
          <span className="inline-block px-4 py-1.5 bg-orange-100 dark:bg-purple-900/30 text-orange-700 dark:text-orange-300 rounded-full text-sm font-semibold mb-5">
            👋 Olá, sou a Rayara
          </span>
          <h1 className="font-display text-5xl md:text-6xl font-bold leading-tight mb-4 text-soft-text dark:text-soft-darkText">
            AI Engineer com foco em <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-purple-600">Python & IA aplicada</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <a href="#projetos" className="px-6 py-3 bg-gradient-to-r from-orange-500 to-purple-600 text-white rounded-full font-semibold hover:opacity-90 transition shadow-lg shadow-purple-500/20">
              Ver projetos
            </a>
